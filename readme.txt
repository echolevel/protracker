...
== COMPILING PROTRACKER ON LINUX ==
 1. Make sure you have 'build-essentials' and 'subversion' installed (if needed)
 ...
 4. Done! The binary ('protracker') is now in pt-clone-code/release/
    To run it, try double-clicking, or type ./protracker   
 5. To get ALT+F4 (copy pattern) and ALT+F5 (paste pattern) working,
    you have to change these keyboard shortcuts in your OS to something else.
    The correct config file location is '~/.protracker/protracker.ini'.
